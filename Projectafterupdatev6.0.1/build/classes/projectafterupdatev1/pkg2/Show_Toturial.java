 ...
 * @author Bassel
 */
public class Show_Toturial extends javax.swing.JFrame {

    /**
     * Creates new form Show_Toturial
     */
    public Show_Toturial() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(playerBackGround);
        playerBackGround.setBounds(0, 0, 600, 380);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Toturial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_Toturial().setVisible(true);
            }
        });
    }
